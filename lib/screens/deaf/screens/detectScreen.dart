          ...
          child: outputs != null && outputs.isNotEmpty
              ? ListView.builder(
                  ...
                  itemBuilder: (BuildContext context, int index) {
                    String currentDetection = outputs[index].label.substring(2);
                    var currentTime = DateTime.now().millisecondsSinceEpoch;
                    if (currentDetection != prev_detection &&
                        (currentTime - prev_time > 1000)) {
                      speak("$currentDetection");
                      prev_detection = currentDetection;
